...
├── Documentacion_Tecnica_Manual_Usuario.pdf   # Documentación técnica completa
...
Consulta el archivo [`Documentacion_Tecnica_Manual_Usuario.pdf`](./Documentacion_Tecnica_Manual_Usuario.pdf) incluido en este repositorio para el detalle completo de: arquitectura, datos, entrenamiento, evaluación, interpretabilidad, manual de uso paso a paso, limitaciones y consideraciones éticas.
